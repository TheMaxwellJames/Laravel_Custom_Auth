                                ...
                                <div class="col-lg-8 px-5">
                                    <form action="" method="POST" id="profile_form">
                                        ...
                                        <div class="my-2">
                                            ...
                                            <input type="text" name="name" class="form-control rounded-0" value="{{$userInfo->name}}">
                                        </div>

                                        <div class="my-2">
                                            <label for="email">Email</label>
                                            <input type="email" name="email" class="form-control rounded-0" value="{{$userInfo->email}}">
                                        </div>
                                        ...
                                        <div class="my-2">
                                            <input type="submit" value="Update Profile" class="btn btn-primary rounded-o float-end" id="profile_btn">
                                        </div>
                                    </form>
                                </div>
                            </div>
